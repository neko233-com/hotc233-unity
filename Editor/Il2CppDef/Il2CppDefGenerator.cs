...
namespace Hotc233.Editor.Il2CppDef
{
    public class Il2CppDefGenerator
    {
        ...
        private void GenerateIl2CppConfig()
        {
            ...
            Debug.Log($"[Hotc233.Editor.Il2CppDef.Generator] output:{_options.UnityVersionOutputFile}");
        }
        ...
        private void GeneratePlaceHolderAssemblies()
        {
            ...
            Debug.Log($"[Hotc233.Editor.Il2CppDef.Generator] output:{_options.AssemblyManifestOutputFile}");
        }
    }
}
