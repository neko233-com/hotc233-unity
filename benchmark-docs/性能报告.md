...
- 更新时间 (UTC): 2026-07-01T03:07:35.8402473Z
...
- 官方 base 最强项: **GameObject Create/Destroy** = 516887.5%
- 业务场景最弱项: **Tween 模拟更新** = 18.6%
- 业务场景最强项: **Struct 传值与字段更新** = 116.3%
...
| CallAOTInstance ParamInt | 0.00 ms / 2500000000 ops/s | 0.14 ms / 7251632 ops/s | 0.09 ms / 10877447 ops/s | 1000 | **34475.0%** | 1.00x | 1.00x | 300% | passed |
| BinOpComplex 复杂数值 | 0.00 ms / 2500000000 ops/s | 0.15 ms / 6657790 ops/s | 0.02 ms / 48934754 ops/s | 1000 | **37550.0%** | 1.00x | 1.00x | 500% | passed |
...
| GameObject Create/Destroy | 0.00 ms / 1250000000 ops/s | 4.14 ms / 241832 ops/s | 3.76 ms / 266015 ops/s | 1000 | **516887.5%** | 1.00x | 1.00x | 300% | passed |
...
| 项目 | hotc233 | HybridCLR 社区版 | Pro 目标估算 | 次数 | hotc / HybridCLR | 追平社区还需 | 追 Pro 还需 | floor | floor status |
|------|---------|------------------|--------------|-----:|-----------------:|-------------:|------------:|------:|--------------|
| Tween 模拟更新 | 0.06 ms / 165017 ops/s | 0.01 ms / 884956 ops/s | 0.00 ms / 2539823 ops/s | 10 | 18.6% | 5.36x | 15.39x | observe | observe-only |
| 协程式 IEnumerator | 0.14 ms / 72622 ops/s | 0.04 ms / 270270 ops/s | 0.01 ms / 775676 ops/s | 10 | 26.9% | 3.72x | 10.68x | observe | observe-only |
| List 池化 Rent/Return | 0.12 ms / 86356 ops/s | 0.04 ms / 284091 ops/s | 0.01 ms / 815341 ops/s | 10 | 30.4% | 3.29x | 9.44x | observe | observe-only |
| Task.WhenAll | 0.00 ms / 5000000 ops/s | 0.00 ms / 14285714 ops/s | 0.00 ms / 41000000 ops/s | 10 | 35.0% | 2.86x | 8.20x | observe | observe-only |
...
| 自定义类虚派发 | 0.01 ms / 833333 ops/s | 0.01 ms / 1369863 ops/s | 0.00 ms / 3931507 ops/s | 10 | 60.8% | 1.64x | 4.72x | observe | observe-only |
| Callback 链 | 0.05 ms / 211416 ops/s | 0.03 ms / 296736 ops/s | 0.01 ms / 851632 ops/s | 10 | 71.2% | 1.40x | 4.03x | observe | observe-only |
| Event 多播 | 0.06 ms / 171821 ops/s | 0.04 ms / 239234 ops/s | 0.01 ms / 686603 ops/s | 10 | 71.8% | 1.39x | 4.00x | observe | observe-only |
| 配置表 Dictionary 查找 | 0.03 ms / 304878 ops/s | 0.03 ms / 363636 ops/s | 0.01 ms / 1043636 ops/s | 10 | 83.8% | 1.19x | 3.42x | observe | observe-only |
| Struct 传值与字段更新 | 0.00 ms / 2040816 ops/s | 0.01 ms / 1754386 ops/s | 0.00 ms / 5035088 ops/s | 10 | **116.3%** | 1.00x | 2.47x | observe | observe-only |
