...
#pragma region type
    ...
    const Il2CppType* Image::ReadArrayType(BlobReader& reader, const Il2CppGenericContainer* klassGenericContainer, const Il2CppGenericContainer* methodGenericContainer)
    {
        ...
        if (type.numsizes > 0)
        {
            type.sizes = (int*)HOTC233_CALLOC(type.numsizes, sizeof(int));
        ...
        {
            type.lobounds = (int*)HOTC233_CALLOC(type.numlobounds, sizeof(int));
    ...
    readAgain:
        ...
        case IL2CPP_TYPE_FNPTR:
        {
            ...
            // 
            //MethodRefSig* method = new (HOTC233_MALLOC(sizeof(MethodRefSig))) MethodRefSig();
        ...
        case IL2CPP_TYPE_VAR:
        {
            ...
            {
                //IL2CPP_ASSERT(hotc233::metadata::IsInterpreterIndex(klassGenericContainer->ownerIndex));
            ...
            IL2CPP_ASSERT(hotc233::metadata::IsInterpreterIndex(gp->ownerIndex));*/
            break;
        }
