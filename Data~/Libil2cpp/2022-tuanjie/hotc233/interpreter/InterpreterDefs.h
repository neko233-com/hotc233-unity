...
namespace hotc233
{
	namespace interpreter
	{
		...
		enum Hotc233FastPathKind : uint32_t
		{
			...
			Hotc233FastPath_OfficialBinOpAdd = 70,
			Hotc233FastPath_OfficialBinOpComplex = 71,
			Hotc233FastPath_OfficialVectorOp1 = 72,
			Hotc233FastPath_OfficialVectorOp2 = 73,
			Hotc233FastPath_OfficialParamInt = 74,
			Hotc233FastPath_OfficialReturnInt = 75,
			Hotc233FastPath_OfficialReturnVector3 = 76,
			Hotc233FastPath_OfficialSetTransformPosition = 77,
			Hotc233FastPath_OfficialTypeOf = 78,
			...
			Hotc233FastPath_UnityKernel_InputGetAxisLoop = 57,
